...
INSERT INTO `doctrine_migration_versions` VALUES ('DoctrineMigrations\\Version20260113235242','2026-01-13 23:53:34',15);
...
CREATE TABLE `yes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_IDENTIFIER_YES` (`yes`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-14  0:55:15
